...
$(function () {
    ...
    var table = new BSTable("listAllLesson",path+ "/examController/listOwnGrade", defaultColunms);
    table.init();
});
...
listAllLesson.initColumn= function () {
    return [
        {title: '所属课程',field: 'NAME', align: 'center', valign: 'middle'},
        {title: '所属试卷',field: 'PAPERNAME', align: 'center', valign: 'middle'},
        {title: '讲师',field: 'USERNAME', align: 'center', valign: 'middle'},
        {title: '试卷得分',field: 'PERFORMANCE', align: 'center', valign: 'middle'},

...
<body>
        ...
        <div id="toolbar">
           <a  id="btn_add" type="button" class="btn btn-primary btn-sm"  href="gotoAddExam">
...
$(function () {
    ...
    var table = new BSTable("listAllLesson",path+ "/examController/listExcemPaper", defaultColunms);
    table.init();
});

...
$(function () {
    ...
    var table = new BSTable("listMyLibrary",path+ "/resourcesController/listMyLibraryPage", defaultColunms);
    table.init();
});
...
listMyLibrary.initColumn= function () {
    return [
        {title: '文章编号', field: 'ID', align: 'center', valign: 'middle',width:'50px'},
        {title: '文章名称',field: 'NAME', align: 'center', valign: 'middle',width:'50px'},
        {title: '文章点赞数',field: 'HITS', align: 'center', valign: 'middle',width:'50px'},
        ...
        {title: '文章下载数',field: 'LIKES', align: 'center', valign: 'middle',width:'50px'},
        {title: '操作', align: 'center', valign: 'middle',width:'50px', formatter: 
       		        	function (value, row, index) {
       		            return "<button class='btn btn-xs btn-info' onclick='readlibraryClick()'><i class='icon-link bigger-180'></i>查看文章</button>&nbsp;"
       	 }}]
    };
</script>
</body>
